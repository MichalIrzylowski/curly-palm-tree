...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_opening_hours_hours_day" AS ENUM('monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday');
  ...
  CREATE TABLE "pages_blocks_hero_block_locales" (
  	"heading" varchar,
  	"tagline" varchar,
  	"primary_cta_label" varchar DEFAULT 'Umów wizytę',
  ...
  CREATE TABLE "team_specialisations" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "opening_hours_hours" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"day" "enum_opening_hours_hours_day" NOT NULL,
  	"open_time" varchar,
  	"close_time" varchar,
  	"is_closed" boolean DEFAULT false
  );
  
  CREATE TABLE "opening_hours_hours_locales" (
  	"note" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "contact_phones_locales" (
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "contact" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"lat" numeric DEFAULT 54.4472595 NOT NULL,
  	"lng" numeric DEFAULT 18.5504898 NOT NULL,
  	"email" varchar,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  CREATE TABLE "contact_locales" (
  	"address" varchar DEFAULT 'ul. 23 Marca 32E, 81-820 Sopot' NOT NULL,
  	"directions_notes" jsonb,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  ALTER TABLE "team_specialisations" ADD CONSTRAINT "team_specialisations_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."team"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "opening_hours_hours" ADD CONSTRAINT "opening_hours_hours_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."opening_hours"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "opening_hours_hours_locales" ADD CONSTRAINT "opening_hours_hours_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."opening_hours_hours"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "contact_phones_locales" ADD CONSTRAINT "contact_phones_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."contact_phones"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_hero_block_media_idx" ON "pages_blocks_hero_block" USING btree ("media_id");
  ...
  CREATE INDEX "_pages_v_blocks_hero_block_media_idx" ON "_pages_v_blocks_hero_block" USING btree ("media_id");
  ...
  CREATE INDEX "team_specialisations_order_idx" ON "team_specialisations" USING btree ("_order");
  CREATE INDEX "team_specialisations_parent_id_idx" ON "team_specialisations" USING btree ("_parent_id");
  CREATE INDEX "team_specialisations_locale_idx" ON "team_specialisations" USING btree ("_locale");
  ...
  CREATE INDEX "opening_hours_hours_order_idx" ON "opening_hours_hours" USING btree ("_order");
  CREATE INDEX "opening_hours_hours_parent_id_idx" ON "opening_hours_hours" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "opening_hours_hours_locales_locale_parent_id_unique" ON "opening_hours_hours_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "contact_phones_locales_locale_parent_id_unique" ON "contact_phones_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "team_specialisations" CASCADE;
  ...
  DROP TABLE "opening_hours_hours" CASCADE;
  DROP TABLE "opening_hours_hours_locales" CASCADE;
  DROP TABLE "opening_hours" CASCADE;
  DROP TABLE "contact_phones" CASCADE;
  DROP TABLE "contact_phones_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_opening_hours_hours_day";`)
}
